...
public class RegistroUsuarioView extends BaseView {
    ...
    private DefaultListModel<ListItem> empresasListModel = new DefaultListModel<>();
    ...
    private void initComponents() {
        ...
        listEmpresas.setModel(empresasListModel);
        listEmpresas.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        lblErrorEmpresa.setText("Seleccione una empresa");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtBuscarEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtBuscarEmpresaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarEmpresaKeyReleased
        ...
        List<ListItem> empresasList = empresaService.listarListItemEmpresa(txtBuscarEmpresa.getText());
        empresasListModel.addAll(empresasList);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
       ...
       txtNombres.setBorder(Constantes.DEFAULT_BORDER);
        ...
        ListItem empresaSeleccionada = listEmpresas.getSelectedValue();
        ...
        Usuario usuario = new Usuario(nombreUsuario, contrasenia, nombres, apellidos, Constantes.ESTADO_ACTIVO, empresaSeleccionada.getValor());
        if (idUsuario == null) {
    ...
    private javax.swing.JList<ListItem> listEmpresas;
    ...
    public void iniciarVentana() {
       limpiar();
        ...
        if (param != null) {
            ...
            if (usuarioExistente.getEmpresa() != null) {
                String textoEmpresa = usuarioExistente.getEmpresa().getNombre() + " - " + usuarioExistente.getEmpresa().getRuc();
                ListItem empresaItem = new ListItem(usuarioExistente.getEmpresa().getIdEmpresa(), textoEmpresa);

                empresasListModel.add(0, empresaItem);
